...
| `adjustment_factor.source` / `.reason` | — | Migration 008 (2026-09-23): 'seam_rescale' marks backfill-seam rescale factors (27,518 rows, 33 symbols), with a reason. The factor>1 gate exempts ONLY these, and only on backfilled vnstock bars (G17). |
