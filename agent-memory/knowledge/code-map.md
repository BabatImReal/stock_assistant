...
**Phase 5 (features) in progress; 23 measures built (breadth + PIT universe on branch `features/breadth-pit-build`). Build 5 is promoted
...
| `scripts/report_features.py` | Occurrence rates and distributions per measure (index and breadth frames supplied), plus the NaN share and why | pandas, `features` |
